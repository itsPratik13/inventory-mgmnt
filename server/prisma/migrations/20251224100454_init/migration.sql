...
-- CreateTable
CREATE TABLE "ExpsenseSummary" (
    "expenseSummaryId" TEXT NOT NULL,
    "totalExpenses" DOUBLE PRECISION NOT NULL,
    "date" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ExpsenseSummary_pkey" PRIMARY KEY ("expenseSummaryId")
);
...
-- AddForeignKey
ALTER TABLE "ExpenseByCategory" ADD CONSTRAINT "ExpenseByCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExpsenseSummary"("expenseSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
